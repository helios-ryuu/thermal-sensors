...
`06:00-18:00` và ban đêm `18:00-06:00` theo múi giờ trình duyệt. Chỉ line
trung bình toàn máy, tốc độ quạt `main` và công suất GPU có fill mờ; các line
khác không tô vùng dưới đường.
